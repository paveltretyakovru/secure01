...
$config = [
    ...
    'components' => [
        'request' => [
            ...
            'cookieValidationKey' => 'sEWaiGQ2ntcBobMv5QY7iy7_-TvZMSLc',
        ],
        'cache' => [
        ...
        'urlManager' => [
            ...
            'rules' => [
              ...
              'admin/offers' => 'admin/offers/index',
              'admin/emails' => 'admin/emails/index',
              'admin/slides' => 'admin/slides/index',
              'admin/ourworks' => 'admin/ourworks/index',
              'admin/callbacks' => 'admin/callbacks/index',
